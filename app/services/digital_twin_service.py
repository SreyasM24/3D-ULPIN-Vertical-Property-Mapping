            ...
            for fl in floors_orm:
                ...
                for u in units_orm:
                    ...
                    unit_prov = {
                        ...
                        "source_reference": u_meta.get("source_reference"),
                        "method": u_meta.get("method") or method_desc,
                        ...
                        "uncertainty_basis": u_meta.get("uncertainty_basis"),
                        "coverage": u_meta.get("coverage", "VALID"),
                        "point_count": u_meta.get("point_count"),
                        "building_point_count": u_meta.get("building_point_count"),
                        "ground_point_count": u_meta.get("ground_point_count"),
                        "point_density_pts_m2": u_meta.get("point_density_pts_m2"),
                        "surface_elevation_m": u_meta.get("surface_elevation_m"),
                        "ground_elevation_m": u_meta.get("ground_elevation_m"),
                        "observed_height_m": u_meta.get("observed_height_m"),
                        "horizontal_crs": u_meta.get("horizontal_crs"),
                        "ai_model": u_meta.get("ai_model"),
                        "ground_method": u_meta.get("ground_method"),
                        ...
                        "requires_review": u_meta.get("requires_review", False) or u_meta.get("conflict_detected", False),
                        "multi_source_evidence": u_meta.get("multi_source_evidence", []),
                        "selected_evidence": u_meta.get("selected_evidence"),
                        "why_selected": u_meta.get("why_selected"),
                        "ai_status": u_meta.get("ai_status"),
                        "conflict_detected": u_meta.get("conflict_detected", False),
                        "conflict_severity": u_meta.get("conflict_severity", "NONE"),
                        "conflict_details": u_meta.get("conflict_details", {}),
                        "fusion_outcome": u_meta.get("fusion_outcome", {}),
                    }
